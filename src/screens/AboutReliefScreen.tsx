...
interface AboutReliefScreenProps { navigation: NativeStackNavigationProp<RootStackParamList, 'AboutRelief'>; }
  ...
  return <ScreenBackground>
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <SoftCard style={styles.section}><SectionHeader title="Legal and support" /><Text style={styles.copy}>Account deletion is available from Profile → Delete account. Public privacy, terms, support, and data-rights endpoints are not configured in this build yet.</Text><Pressable accessibilityRole="button" onPress={() => navigation.navigate('LegalInfo', { section: 'privacy' })} style={styles.link}><Text style={styles.linkText}>Privacy state</Text></Pressable><Pressable accessibilityRole="button" onPress={() => navigation.navigate('LegalInfo', { section: 'terms' })} style={styles.link}><Text style={styles.linkText}>Terms state</Text></Pressable><Pressable accessibilityRole="button" onPress={() => navigation.navigate('LegalInfo', { section: 'support' })} style={styles.link}><Text style={styles.linkText}>Support state</Text></Pressable><Pressable accessibilityRole="button" onPress={() => navigation.navigate('LegalInfo', { section: 'data_request' })} style={styles.link}><Text style={styles.linkText}>Data request state</Text></Pressable></SoftCard>
      </ScrollView>
    </SafeAreaView>
  </ScreenBackground>;
};
